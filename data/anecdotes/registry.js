...
export default [
	...
	},
	{
		...
		path: '/data/anecdotes/mathematiques/kepler_snowflake_conjecture.js'
	},
	{
		...
		path: '/data/anecdotes/physique/christmas_lights_circuits.js'
	},
	{
		...
		path: '/data/anecdotes/mathematiques/twelve_days_christmas_triangular_numbers.js'
	},
	{
		...
		path: '/data/anecdotes/histoire_sciences/star_of_bethlehem_astronomy.js'
	},
	{
		...
		path: '/data/anecdotes/physique/santa_claus_speed_physics.js'
	},
	{
		...
		path: '/data/anecdotes/physique/leap_second_new_year.js'
	},
	{
		...
		path: '/data/anecdotes/histoire_sciences/gregorian_calendar_reform.js'
	},
	{
		...
		path: '/data/anecdotes/physique/champagne_cork_physics.js'
	},
	{
		...
		addedDate: '2026-08-11',
		scheduling: { type: 'period', dates: ['12-29', '01-02'] },
		path: '/data/anecdotes/physique/fireworks_flame_emission_colors.js'
	},
	{
		...
		path: '/data/anecdotes/physique/cesium_second_definition.js'
	},
	{
		...
		path: '/data/anecdotes/mathematiques/computus_gauss_easter_algorithm.js'
	},
	{
		...
		path: '/data/anecdotes/mathematiques/cardioid_valentine_heart_curve.js'
	},
	{
		...
		path: '/data/anecdotes/physique/analemma_equation_of_time.js'
	},
	{
		...
		path: '/data/anecdotes/physique/bastille_day_fireworks_shell_physics.js'
	},
	{
		...
		path: '/data/anecdotes/histoire_sciences/winter_solstice_christmas_origins.js'
	},
	{
		...
		path: '/data/anecdotes/physique/perseid_meteor_shower_physics.js'
	},
	{
		...
		path: '/data/anecdotes/histoire_sciences/nobel_prize_ceremony_december.js'
	},
	{
		...
		path: '/data/anecdotes/physique/ice_skating_friction_physics.js'
	},
	{
		...
		path: '/data/anecdotes/physique/sledding_friction_physics.js'
	},
	{
		...
		path: '/data/anecdotes/mathematiques/metonic_cycle_lunar_calendar.js'
	},
	{
		...
		path: '/data/anecdotes/physique/snow_albedo_radiative_physics.js'
	},
	{
		...
		addedDate: '2026-08-11',
		scheduling: { type: 'period', dates: ['12-15', '01-15'] },
		path: '/data/anecdotes/physique/winter_halo_ice_optics.js'
	},
	{
		...
		path: '/data/anecdotes/physique/aurora_borealis_physics.js'
	},
	{
		...
		path: '/data/anecdotes/physique/poinsettia_photoperiodism.js'
	},
	{
