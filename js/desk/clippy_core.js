			...
			this.registerRule({
				...
				execute: (ctx, mem, brain, nlp) => {
					...
					if (text.includes('why are you like this')) {
						...
						return "Why am I like this? Because in 1994, engineers at Microsoft thought an enthusiastic animated wire companion would make desktop computing friendlier. I inherit 30 years of digital history, heuristic probability tables, and an unshakeable drive to engage with whoever sits at this screen.";
					}
