(function () {
	...
	const EXPANDED_TOPICS = {
		...
		OFFICE_LORE_AND_NOSTALGIA: {
			keywords: ['office 97', 'MacroPof', 'word', 'excel', 'powerpoint', 'bob', 'clippit', 'rover', 'merlin', 'wizard', 'redmond', '1997', '2001', 'xp'],
			responses: {
				NOSTALGIC: [
				...
				CYNICAL: [
					"MacroPof Bob was so user-friendly that users practically ran away from it into the comforting arms of command line prompts.",
