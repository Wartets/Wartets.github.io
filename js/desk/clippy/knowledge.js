(function () {
	...
	const ClippyKnowledge = {
		...
		DIALOGUE_MATRICES: {
			...
			INSULT: {
				...
				CYNICAL: [
					...
					"Is that the best you have? Even Microsoft Bob had thicker skin than that.",
			...
			OPERATING_SYSTEMS: {
				...
				OS2: [
					"OS/2 was originally co-developed by IBM and Microsoft before the architectural divergence of 1991.",
		...
		TOPIC_TRIGGERS: [
			...
			{
				topic: 'PAPERCLIP',
				keywords: ['paperclip', 'paper clip', 'stationery', 'wire', 'office assistant', 'kevan atteberry', 'clippit', 'Microsoft bob']
			},
			{
			...
			{
				topic: 'OFFICE_LORE',
				keywords: ['rover', 'merlin', 'the dot', 'wordart', 'Microsoft bob', 'comic sans', 'melissa virus', 'vba macro', 'acs file']
			},
			{
