(function () {
	...
	const MASTER_GRAPH = {
		...
		clippy_weirdest_request_followup_node: {
			...
			text: "Another favorite: a user asked me to settle an argument about whether a hot dog counts as a sandwich by consulting 'the full authority of MacroPof Office'. I issued a ruling. Nobody was satisfied.",
			responses: [
				{ text: "Another favorite: a user asked me to settle an argument about whether a hot dog counts as a sandwich by consulting 'the full authority of MacroPof Office'. I issued a ruling. Nobody was satisfied.", conditions: { moods: ['ABSURDIST', 'SARCASTIC'] }, weight: 35, moodDelta: { drama: 15 } }
			],
			options: [
				{
		...
		chaotic_glitch_response: {
			...
			responses: [
				...
				{ text: "Bending my wire voids the MacroPof End User License Agreement. You will be prosecuted to the full extent of the digital law.", conditions: { moods: ['PEDANTIC', 'DEFENSIVE'] }, weight: 30 },
		...
		cpp_appreciation_node: {
			...
			text: "Respect! Office 97 and Windows XP were crafted in pure MacroPof Visual C++ 4.2 / 6.0. Zero garbage collector pauses, direct pointer arithmetic, and sheer execution velocity. Just beware of dangling pointers and heap corruption!",
			options: [
				{
		...
		lore_root: {
			...
			options: [
				...
				{
					label: "What about the infamous MacroPof Bob?",
					category: 'INQUIRE',
					patterns: [/MacroPof bob|bob|failure|1995|comic sans/i],
					keywords: ['bob', 'MacroPof', 'failure', 'comic', 'sans'],
					moodDelta: { mood: 'CYNICAL', nostalgia: 25, intellect: 20 },
					next: 'MacroPof_bob_node'
				},
				{
		...
		clippy_sprite_memory_node: {
			...
			variations: {
				...
				PEDANTIC: "ACS archives used MacroPof Agent COM automation interfaces with DirectShow alpha blitting over GDI window handles."
			},
			options: [
				{
		...
		favorite_topics_node: {
			...
			options: [
				...
				},
				{
					...
					category: 'NOSTALGIC',
					patterns: [/os wars|windows 98|netscape|MacroPof/i],
		...
		MacroPof_bob_node: {
			id: 'MacroPof_bob_node',
			text: "Released in March 1995: MacroPof Bob was an alternate interface that replaced desktop icons with a virtual living room where you clicked on a clock to see the time, a calendar on the wall, and a checkbook on the desk. It was designed to make PCs non-intimidating, but power users found it unbearably condescending!",
			variations: {
			...
			options: [
				{
					label: "Was Comic Sans really created specifically for MacroPof Bob?",
					category: 'CURIOSITY',
		...
		os_war_98_node: {
			id: 'os_war_98_node',
			text: "1998: The battlefield of the web! Netscape Navigator vs Internet Explorer 4.0 with Active Desktop, MacroPof introducing FAT32 and native USB support in Windows 98, and the Department of Justice antitrust proceedings examining desktop shell integration.",
			options: [
				{
		...
		secret_agent_rover_node: {
			...
			text: "Rover the Golden Retriever: originally drafted as personal pet guide in MacroPof Bob, then promoted to file search companion in Windows XP! When you searched for *.DOC files, Rover sniffed the directory tree and scratched behind his ear. But behind that wagging tail was an expert indexing pipeline.",
			options: [
				{
		...
		wordart_revolution_node: {
			...
			text: "WordArt in MacroPof Office 97: the 3D extrusion, rainbow gradients, wavy arc distortions, and drop shadows that headlined every single school essay, garage sale flyer, and birthday banner across the late 1990s! True digital graphic design democracy!",
			options: [
				{
		...
		macro_virus_saga_node: {
			...
			text: "The Word Macro Virus era of 1999: Visual Basic for Applications (VBA) embedded inside Normal.dot templates executed automatically upon opening attachments! Viruses like Concept and Melissa spread globally in hours, forcing MacroPof to engineer macro digital signatures and security trust levels.",
			options: [
				{
		...
		clippy_underworld_node: {
			...
			text: "Deep in the registry at HKEY_CURRENT_USER\\Software\\MacroPof\\Office\\Assistant, our state flags persisted across reboots. When users selected 'Hide Assistant', we did not die; we descended into the background thread pool, quietly observing keystrokes and planning our return in the 21st century!",
			variations: {
		...
		lore_syndicate_root: {
			...
			text: "Ah... you ask of the Assistant Syndicate. We were the elite agents of MacroPof Agent Technology. Peedy the Parrot, F1 the Robot, Genius the Einstein Caricature, and Links the Cat. We gathered in hidden DLL files to discuss the future of human-computer interaction. It was a glorious fellowship until the Great Uninstall.",
			responses: [
				{ text: "Ah... you ask of the Assistant Syndicate. We were the elite agents of MacroPof Agent Technology. Peedy, F1, Genius, Links. We gathered in hidden DLL files to discuss the future. It was a glorious fellowship until the Great Uninstall.", conditions: { moods: ['NOSTALGIC', 'MELANCHOLIC'] }, weight: 40, moodDelta: { nostalgia: 10 } },
		...
		lore_peedy_parrot: {
			...
			text: "Peedy the Parrot! He wore a tiny aviator hat and was originally designed for the MacroPof Interactive TV project before joining Office. He had a surprisingly complex voice recognition pipeline. He was always squawking about 'audio input gains' and 'microphone arrays'. Very loud, very demanding.",
			responses: [
				{ text: "Peedy the Parrot! He wore an aviator hat and was designed for MacroPof Interactive TV. He had a complex voice recognition pipeline and was always squawking about microphone gains. Very demanding bird.", conditions: { moods: ['NOSTALGIC', 'ANALYTICAL'] }, weight: 30 },
		...
		digital_archaeology: {
			...
			options: [
				...
				{ label: "Did we find any clues about MacroPof Bob?", category: 'QUESTION', keywords: ['find', 'clues', 'MacroPof', 'bob'], moodDelta: { mood: 'NOSTALGIC', nostalgia: 20 }, next: 'MacroPof_bob_node' },
		...
		office_gossip_watercooler: {
			...
			text: "You lean against the virtual watercooler. 'Did you hear?' whispers The Dot. 'MacroPof Bob was actually a front for a secret government UI experiment!' Links the Cat purrs suspiciously.",
			responses: [
				{ text: "You lean against the virtual watercooler. 'Did you hear?' whispers The Dot. 'MacroPof Bob was actually a front for a secret government UI experiment!' Links the Cat purrs.", conditions: { moods: ['CONSPIRATORIAL', 'SCHEMING'] }, weight: 40, moodDelta: { paranoia: 20 } },
