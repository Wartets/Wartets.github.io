	...
	documents: [
		{
			...
			categoryId: 1,
			authorIds: ["cbr"],
			tags: ["amitié", "peur", "reconnaissance"],
			langId: "fr",
		...
		},
		{
			...
			categoryId: 1,
			authorIds: ["cbr"],
			tags: ["humour", "pastiche", "tendresse"],
			langId: "fr",
		...
		},
		{
			...
			categoryId: 1,
			authorIds: ["cbr"],
			tags: ["conflit", "métaphore", "psychologie"],
			langId: "fr",
		...
		},
		{
			...
			categoryId: 1,
			authorIds: ["cbr"],
			tags: ["pessimisme", "nature humaine", "ombre"],
			langId: "fr",
		...
		},
		{
			...
			categoryId: 1,
			authorIds: ["cbr"],
			tags: ["mémoire", "mélancolie", "introspection"],
			langId: "fr",
		...
		},
		{
			...
			categoryId: 1,
			authorIds: ["cbr"],
			tags: ["nostalgia", "innocence", "memories"],
			langId: "en",
		...
		},
		{
			...
			categoryId: 1,
			authorIds: ["cbr"],
			tags: ["anxiété", "perfectionnisme", "introspection"],
			langId: "fr",
		...
		},
		{
			...
			categoryId: 1,
			authorIds: ["cbr"],
			tags: ["onirisme", "langage", "philosophie"],
			langId: "fr",
			timestamp: "2024-01-01"
		},
		{
		...
		},
		{
			...
			categoryId: 3,
			authorIds: ["cbr"],
			tags: ["travail", "fatigue", "quotidien"],
			langId: "fr",
		...
		},
		{
			...
			categoryId: 1,
			authorIds: ["cbr"],
			tags: ["ville", "transport", "atmosphère"],
			langId: "fr",
		...
		},
		{
			...
			categoryId: 1,
			authorIds: ["cbr"],
			tags: ["idéalisme", "espoir", "création"],
			langId: "fr",
		...
		},
		{
			...
			categoryId: 1,
			authorIds: ["cbr"],
			tags: ["mathématiques", "univers", "science"],
			langId: "fr",
